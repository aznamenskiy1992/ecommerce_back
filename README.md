...
1. `test_print_object_info` - проверяет вывод в консоль информации о созданном объекте
...
Определяет обязательный интерфейс для всех товаров в системе.
...
**Функционал:**
- Автоматически выводит информацию о созданном объекте в консоль 
- Реализует метод `__repr__` для стандартизированного представления объектов
